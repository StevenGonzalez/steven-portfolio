...
export default function ProjectRow({ project }: { project: ProjectDetail }) {
  return (
    <motion.div whileHover={{ y: -1 }}>
      <Link
        href={`/projects/${project.slug}`}
        className="group block border-b border-zinc-200/60 py-4 transition hover:bg-zinc-50 dark:border-zinc-800/60 dark:hover:bg-zinc-900"
      >
