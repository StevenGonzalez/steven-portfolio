...
export default function Footer() {
  return (
    <footer className="relative z-[500] shrink-0 px-3 pb-2 pt-1.5 sm:px-4 [@media(max-height:640px)]:pb-1.5 [@media(max-height:640px)]:pt-1">
      <GlowPanel className="surface-panel mx-auto max-w-6xl rounded-2xl px-4 py-2.5 shadow-[0_18px_44px_-38px_rgba(24,24,27,0.28)] dark:shadow-[0_20px_48px_-40px_rgba(0,0,0,0.7)]">
