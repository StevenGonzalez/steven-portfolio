    ...
    <div className="flex flex-1 flex-col">
      ...
      >
        <div className="grid gap-2.5 lg:grid-cols-[minmax(0,1.45fr)_minmax(18rem,0.95fr)]">
          <GlowPanel className="surface-panel flex h-full flex-col rounded-[1.75rem] px-5 py-3.5 sm:px-6 sm:py-4">
          ...
          <GlowPanel className="surface-panel rounded-[1.75rem] px-5 py-3.5 sm:px-6 sm:py-4">
