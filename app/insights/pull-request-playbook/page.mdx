...
<ThoughtPost
  ...
  toc={[
    { title: "The philosophy", href: "#the-philosophy" },
    { title: "Right-sized, in practice", href: "#right-sized-in-practice" },
    { title: "Anatomy of a great PR", href: "#the-anatomy-of-a-great-pr" },
    { title: "Common anti-patterns", href: "#common-anti-patterns-and-fixes" },
    { title: "For reviewers", href: "#for-reviewers" },
    { title: "A simple checklist", href: "#a-simple-checklist" },
  ]}
  description="A practical guide to writing clear, right-sized pull requests that get reviewed well."
>
